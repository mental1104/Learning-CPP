...
public:
    ...
    ResultIter begin() const { return nos->begin(); }//newly added
    ResultIter end() const { return nos->end(); }//newly added
    shared_ptr<StrBlob> get_file() const { return input; }//newly added
private:
    string word;
